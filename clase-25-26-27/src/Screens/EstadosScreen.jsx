...
const EstadosScreen = () => {
    ...
    const incrementar = () => {
        ...
        setMensajeError(''); // Limpiar el mensaje de error si la operación es válida
    }
    ...
    const decrementar = () => {
        if(contador > 1){
            ...
            setMensajeError('No se puede restar más.');
        }
    ...
    */
    ...
    return (
        <div>
            ...
            {mensajeError && <h2 Style={{ color: 'red' }}>{mensajeError}</h2>}
